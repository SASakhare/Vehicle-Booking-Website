import { Bike, Bus, Car, CarTaxiFront, ChevronLeft, ChevronRight, SparkleIcon, Sparkles, Truck } from 'lucide-react';
    ...
    <div className='w-full bg-white py-20 px-4 overflow-hidden'>
      <div className='max-w-7xl mx-auto'>
        ...
        >
          <div>
            <div className='flex items-center gap-2 mb-3'>
              ...
              <span className='text-[10px] font-black uppercase tracking-[0.2rem]'>Fleet</span>
            </div>
            ...
            <p
              className='text-zinc-400 text-sm mt-3 font-medium'
            >
          ...
          <div className='hidden sm:flex items-center gap-2'>
            ...
            justify-center hover:bg-zinc-900 hover:border-zinc-900 hover:text-white disabled:opacity-25
            disabled:hover:bg-white disabled:hover:text-zinc-900 disabled:hover:border-zin-200 transition-all text-zinc-700 shadow-sm
            '
            >
        ...
        <div className='relative'>
          ...
          <div
            ref={sliderRef}
            className='flex gap-4 pt-20 overflow-x-auto scroll-smooth pb-4 px-1'
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <motion.div
                        animate={{
                          backgroundColor: isHovered ? "rgba(225,255,255,0.12)" : "#f4f4f5",
                        ...
                        uppercase tracking-[0.18em] px-2.5 rounded-full mb-5 transition-colors
                        '
                      >
                        <Sparkles size={8} />
                        {
